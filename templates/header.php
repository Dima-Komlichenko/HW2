            ...
            <div class="collapse navbar-collapse nav-collapse">
                <div class="menu-container">
                    <ul class="navbar-nav navbar-nav-right">
                        <li class="nav-item"><a class="nav-item-child nav-item-hover active" href="../index.php?oenPage=index.php">Home</a></li>
                        <li class="nav-item"><a class="nav-item-child nav-item-hover" href="../index.php?openPage=pricing.php">Pricing</a></li>
                        <li class="nav-item"><a class="nav-item-child nav-item-hover" href="../index.php?openPage=about.php">About</a></li>
                        <li class="nav-item"><a class="nav-item-child nav-item-hover" href="../index.php?openPage=products.php">Products</a></li>
                        <li class="nav-item"><a class="nav-item-child nav-item-hover" href="../index.php?openPage=faq.php">FAQ</a></li>
                        <li class="nav-item"><a class="nav-item-child nav-item-hover" href="../index.php?openPage=contact.php">Contact</a></li>
                    </ul>
                </div>
            </div>
            <!-- End Navbar Collapse -->
